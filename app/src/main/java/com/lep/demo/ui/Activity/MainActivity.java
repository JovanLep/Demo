...
public class MainActivity extends AppCompatActivity {
    ...
    private List<BannerEntity.TopStoriesBean> list;
...
//                       向下执行
    ...
    private class MyViewholder implements Holder<BannerEntity.TopStoriesBean> {
        ...
        @Override
        public void UpdateUI(Context context, int position, BannerEntity.TopStoriesBean data) {
//            加载Banner图片
            Glide.with(context)
                    .load(data.getImage())
                    .into(bannerimag);
